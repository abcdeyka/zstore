...
class Account  
{
    ...
    */
    public static function getList($namewithcode =false,$onlyman=false) {
     ...
     //    $ret[112]='Малоцінні необоротні матеріальні активи';
       ...
       //  $ret[203]='Паливо';
         ...
         $ret[22]='МШП';
         $ret[23]='Виробництво';
         $ret[25]='Напівфабрикати';
         $ret[26]='Готова продукція';
         $ret[28]='Товари';
         $ret[30]='Каса';
         $ret[31]='Банк';
         $ret[36]='Розрахунки з покупцями';
         $ret[37]='Розрахунки з різними дебіторами';
    //     $ret[371]='Розрахунки за виданими авансами';
         $ret[372]='Розрахунки з підзвітними особами';
         $ret[40]='Власний капітал';
         $ret[44]='Нерозподілений прибуток';
         ...
         $ret[66]='Розрахунки по заробітній платі';
         $ret[68]='Розрахунки за іншими операціями';
    //     $ret[681]='Розрахунки за отриманими авансами';
         ...
         $ret[941]='Накладні витрати';
         $ret[942]='Отримані послуги';
         $ret[943]='Комуналка';
         $ret[944]='Аренда';
         $ret[947]='Недостачі та втрати від псування цінностей';
         $ret[949]='Інші витрати операційної діяльності';
         $ret[97]='Інші витрати';
